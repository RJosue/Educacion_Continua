...
while($row = $query1->fetch()){
	...
	switch($cont){
		case 1:
			...
			<div class="row">
			  <div class="col-md">
						<div class="card text-white bg-primary mb-3" style="max-width: 90%;">
			  ...
			  <div class="col-md">
						<div class="card text-white bg-primary mb-3" style="max-width: 90%;">
						   <div class="card-header" style="text-align: center; font-weight: bold;">'.$row["nombre"].'</div>
								   <div class="card-body">
									   <h5 class="card-title">Salon: '.$row["salon"].'</h5>
									   <p class="card-text">Inicio: '.$row["fechai"].' Hora: '.$row["horai"].'</p>
									   <p class="card-text">Fin: '.$row["fechaf"].' Hora: '.$row["horaf"].'</p>
								   </div>
					  </div>
			  </div>  ';
		break;
